...
?>
	...
	<header class="site-header">
		...
		<nav class="site-header-nav sh-item">
			<a class="nav-emag" href="<?php echo esc_url( home_url( '/e-magazine/' ) ); ?>"><span><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
